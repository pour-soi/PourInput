...
from PySide6.QtCore import QObject, Property, QCoreApplication, QRectF, Qt, QUrl, Signal, Slot, QFileInfo, QEvent, QTimer
...
def main():
    ...
    qml_engine.rootContext().setContextProperty("appName", APP_NAME)
