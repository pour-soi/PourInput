...
| 鼠标与配置文件 | 通用设置 |
|---|---|
| ![PourInput 英文浅色模式下的鼠标与配置文件页面](images/Screenshot_mouse.png) | ![PourInput 简体中文浅色模式下的通用设置页面](images/Screenshot_settings.png) |

![PourInput 简体中文浅色模式下的通用鼠标模式页面](images/Screenshot.png)
...
版本说明：
[v1.3.0 — PourInput 视觉系统](https://github.com/pour-soi/PourInput/releases/tag/v1.3.0)

安装：

1. 下载 `PourInput-v1.3.0-Windows.zip`。
2. 解压 zip 文件。
...
运行时结构请从[架构概览](docs/ARCHITECTURE.md)开始阅读；设计与可视化发布指南请参阅 [Pour 产品家族设计系统](docs/POUR_DESIGN_SYSTEM.md)。
