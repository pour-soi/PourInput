...
<p align="center">
  <img src="images/Screenshot_mouse.png" alt="PourInput 英文浅色模式下的鼠标与配置文件页面">
</p>
...
| 通用设置 | 通用鼠标模式 |
|---|---|
| ![PourInput 简体中文浅色模式下的通用设置页面](images/Screenshot_settings.png) | ![PourInput 简体中文浅色模式下的通用鼠标模式页面](images/Screenshot.png) |
