...
_TRANSLATIONS = {
    "en": {
        ...
        "mouse.connect_mouse": "Connect a compatible mouse",
        ...
        "mouse.turn_on_mouse": "Connect or enable a compatible mouse to start customizing buttons",
        ...
        "mouse.click_action": "Click Action",
        "mouse.long_press_action": "Long Press Action",
        "mouse.tap": "Tap: ",
        ...
        "mouse.add_app_dialog.desc": "Choose an app. PourInput will switch to this profile when that app is focused.",
        ...
        "scroll.appearance_desc": "Choose whether PourInput follows the system, stays light, or stays dark.",
        "scroll.system": "System",
        "scroll.light": "Light",
        "scroll.dark": "Dark",
        "scroll.startup": "Startup",
        "scroll.startup_desc": "Start PourInput at login on supported desktop platforms, and choose whether the settings window opens on launch or the app stays in the system tray.",
        "scroll.start_at_login": "Start at login",
        "scroll.start_minimized": "Start minimized",
        "scroll.screenshots": "Screenshots",
        "scroll.screenshots_desc": "Choose where PourInput saves screenshot file actions. Clipboard actions are unaffected.",
        ...
        "scroll.check_for_updates_desc": "Notify when a newer PourInput release is available. Downloads and installation stay manual.",
        "scroll.update_idle": "PourInput can check for new releases.",
        "scroll.update_available": "PourInput %1 is available.",
        ...
        "scroll.update_ready": "Ready to install after PourInput quits.",
        ...
        "scroll.update_manual": "A new PourInput release is available. Download it from the release page and install manually.",
        "scroll.update_manual_windows": "A new PourInput release is available. Download it from the release page and install manually on Windows.",
        "scroll.update_manual_macos": "A new PourInput release is available. Download it from the release page and install manually on macOS.",
        "scroll.update_manual_linux": "A new PourInput release is available. Download it from the release page and install manually on Linux.",
        ...
        "scroll.update_error_network_error": "PourInput could not reach the update service. Try again later.",
        ...
        "scroll.update_error_permission_denied": "PourInput does not have permission to prepare the update.",
        "scroll.update_error_file_error": "PourInput could not write the update files.",
        ...
        "scroll.update_error_older_build": "PourInput rejected an older update.",
        ...
        "key_capture.error.unsupported_key": "Choose a different key. %1 isn't available in PourInput.",
        ...
        "accessibility.text": (
            "PourInput needs Accessibility permission to intercept "
            "mouse button events.\n\n"
            "macOS should have opened the System Settings prompt.\n"
            "Please grant permission, then restart PourInput."
        ),
        ...
        # About dialog
        "about.title": "PourInput",
        "about.subtitle": "Runtime, release, and project details.",
    ...
    "zh_CN": {
        ...
        "mouse.turn_on_mouse": "\u8fde\u63a5\u6216\u542f\u7528\u517c\u5bb9\u7684\u9f20\u6807\u4ee5\u5f00\u59cb\u81ea\u5b9a\u4e49\u6309\u952e",
        ...
        "mouse.add_app_dialog.desc": "\u9009\u62e9\u4e00\u4e2a\u5e94\u7528\u3002\u5f53\u8be5\u5e94\u7528\u5904\u4e8e\u7126\u70b9\u65f6\uff0cPourInput \u5c06\u5207\u6362\u5230\u6b64\u914d\u7f6e\u3002",
        ...
        "scroll.appearance_desc": "\u9009\u62e9 PourInput \u662f\u8ddf\u968f\u7cfb\u7edf\u3001\u4fdd\u6301\u6d45\u8272\u8fd8\u662f\u4fdd\u6301\u6df1\u8272\u3002",
        "scroll.system": "\u7cfb\u7edf",
        "scroll.light": "\u6d45\u8272",
        "scroll.dark": "\u6df1\u8272",
        "scroll.startup": "\u542f\u52a8",
        "scroll.startup_desc": "\u5728\u53d7\u652f\u6301\u7684\u684c\u9762\u5e73\u53f0\u4e0a\u968f\u767b\u5f55\u542f\u52a8 PourInput\uff0c\u5e76\u9009\u62e9\u542f\u52a8\u65f6\u662f\u5426\u6253\u5f00\u8bbe\u7f6e\u7a97\u53e3\u6216\u4ec5\u4fdd\u6301\u5728\u7cfb\u7edf\u6258\u76d8\u3002",
        "scroll.start_at_login": "\u5f00\u673a\u81ea\u542f\u52a8",
        "scroll.start_minimized": "\u542f\u52a8\u65f6\u6700\u5c0f\u5316",
        "scroll.screenshots": "\u622a\u56fe",
        "scroll.screenshots_desc": "\u9009\u62e9 PourInput \u4fdd\u5b58\u622a\u56fe\u6587\u4ef6\u52a8\u4f5c\u7684\u4f4d\u7f6e\u3002\u526a\u8d34\u677f\u52a8\u4f5c\u4e0d\u53d7\u5f71\u54cd\u3002",
        ...
        "scroll.check_for_updates_desc": "\u6709\u65b0\u7248 PourInput \u53ef\u7528\u65f6\u901a\u77e5\u3002\u4e0b\u8f7d\u548c\u5b89\u88c5\u4ecd\u9700\u624b\u52a8\u5b8c\u6210\u3002",
        "scroll.update_idle": "PourInput \u53ef\u4ee5\u68c0\u67e5\u65b0\u7248\u672c\u3002",
        "scroll.update_available": "PourInput %1 \u53ef\u7528\u3002",
        "scroll.update_checking": "\u6b63\u5728\u68c0\u67e5\u66f4\u65b0...",
        "scroll.update_downloading": "\u6b63\u5728\u4e0b\u8f7d\u66f4\u65b0...",
        "scroll.update_verifying": "\u6b63\u5728\u9a8c\u8bc1\u66f4\u65b0...",
        "scroll.update_ready": "PourInput \u9000\u51fa\u540e\u5373\u53ef\u5b89\u88c5\u3002",
        ...
        "scroll.update_manual": "\u6709\u65b0\u7248 PourInput \u53ef\u7528\u3002\u8bf7\u4ece\u53d1\u5e03\u9875\u4e0b\u8f7d\u5e76\u624b\u52a8\u5b89\u88c5\u3002",
        "scroll.update_manual_windows": "\u6709\u65b0\u7248 PourInput \u53ef\u7528\u3002\u8bf7\u4ece\u53d1\u5e03\u9875\u4e0b\u8f7d\u5e76\u5728 Windows \u4e0a\u624b\u52a8\u5b89\u88c5\u3002",
        "scroll.update_manual_macos": "\u6709\u65b0\u7248 PourInput \u53ef\u7528\u3002\u8bf7\u4ece\u53d1\u5e03\u9875\u4e0b\u8f7d\u5e76\u5728 macOS \u4e0a\u624b\u52a8\u5b89\u88c5\u3002",
        "scroll.update_manual_linux": "\u6709\u65b0\u7248 PourInput \u53ef\u7528\u3002\u8bf7\u4ece\u53d1\u5e03\u9875\u4e0b\u8f7d\u5e76\u5728 Linux \u4e0a\u624b\u52a8\u5b89\u88c5\u3002",
        "scroll.update_no_asset": "\u6b64\u7535\u8111\u6ca1\u6709\u53ef\u7528\u7684\u66f4\u65b0\u5305\u3002",
        "scroll.update_error": "\u65e0\u6cd5\u51c6\u5907\u66f4\u65b0\u3002",
        "scroll.update_error_check_first": "\u8bf7\u5148\u68c0\u67e5\u66f4\u65b0\u3002",
        "scroll.update_error_network_error": "PourInput \u65e0\u6cd5\u8fde\u63a5\u66f4\u65b0\u670d\u52a1\u3002\u8bf7\u7a0d\u540e\u91cd\u8bd5\u3002",
        "scroll.update_error_metadata_missing": "\u66f4\u65b0\u4fe1\u606f\u5c1a\u672a\u51c6\u5907\u597d\u3002\u8bf7\u6253\u5f00\u53d1\u5e03\u9875\u624b\u52a8\u5b89\u88c5\u3002",
        "scroll.update_error_metadata_invalid": "\u65e0\u6cd5\u8bfb\u53d6\u66f4\u65b0\u4fe1\u606f\u3002\u8bf7\u6253\u5f00\u53d1\u5e03\u9875\u624b\u52a8\u5b89\u88c5\u3002",
        "scroll.update_error_permission_denied": "PourInput \u6ca1\u6709\u51c6\u5907\u66f4\u65b0\u7684\u6743\u9650\u3002",
        "scroll.update_error_file_error": "PourInput \u65e0\u6cd5\u5199\u5165\u66f4\u65b0\u6587\u4ef6\u3002",
        ...
        "scroll.update_error_older_build": "PourInput \u5df2\u62d2\u7edd\u8f83\u65e7\u7684\u66f4\u65b0\u3002",
        ...
        "key_capture.error.unsupported_key": "\u8bf7\u9009\u62e9\u5176\u4ed6\u6309\u952e\u3002%1 \u5728 PourInput \u4e2d\u4e0d\u53ef\u7528\u3002",
        ...
        "accessibility.text": (
            "PourInput \u9700\u8981\u8f85\u52a9\u529f\u80fd\u6743\u9650\u4ee5\u62e6\u622a\u9f20\u6807\u6309\u952e\u4e8b\u4ef6\u3002\n\n"
            "macOS \u5e94\u5df2\u6253\u5f00\u7cfb\u7edf\u8bbe\u7f6e\u63d0\u793a\u3002\n"
            "\u8bf7\u6388\u4e88\u6743\u9650\uff0c\u7136\u540e\u91cd\u65b0\u542f\u52a8 PourInput\u3002"
        ),
    ...
    "zh_TW": {
        ...
        "mouse.turn_on_mouse": "\u9023\u63a5\u6216\u555f\u7528\u76f8\u5bb9\u7684\u6ed1\u9f20\u4ee5\u958b\u59cb\u81ea\u8a02\u6309\u9375",
        ...
        "mouse.click_action": "\u9ede\u64ca\u52d5\u4f5c",
        "mouse.long_press_action": "\u9577\u6309\u52d5\u4f5c",
        "mouse.tap": "\u9ede\u64ca\uff1a",
        ...
        "mouse.add_app_dialog.desc": "\u9078\u64c7\u4e00\u500b\u61c9\u7528\u7a0b\u5f0f\u3002\u7576\u8a72\u61c9\u7528\u7a0b\u5f0f\u8655\u65bc\u7126\u9ede\u6642\uff0cPourInput \u5c07\u5207\u63db\u5230\u6b64\u8a2d\u5b9a\u6a94\u3002",
        ...
        "scroll.appearance_desc": "\u9078\u64c7 PourInput \u662f\u8ddf\u96a8\u7cfb\u7d71\u3001\u4fdd\u6301\u6dfa\u8272\u9084\u662f\u4fdd\u6301\u6df1\u8272\u3002",
        "scroll.system": "\u7cfb\u7d71",
        "scroll.light": "\u6dfa\u8272",
        "scroll.dark": "\u6df1\u8272",
        "scroll.startup": "\u555f\u52d5",
        "scroll.startup_desc": "\u5728\u53d7\u652f\u63f4\u7684\u684c\u9762\u5e73\u53f0\u4e0a\u96a8\u767b\u5165\u555f\u52d5 PourInput\uff0c\u4e26\u9078\u64c7\u555f\u52d5\u6642\u662f\u5426\u958b\u555f\u8a2d\u5b9a\u8996\u7a97\u6216\u50c5\u4fdd\u6301\u5728\u7cfb\u7d71\u5217\u3002",
        "scroll.start_at_login": "\u767b\u5165\u6642\u555f\u52d5",
        "scroll.start_minimized": "\u555f\u52d5\u6642\u6700\u5c0f\u5316",
        "scroll.screenshots": "\u622a\u5716",
        "scroll.screenshots_desc": "\u9078\u64c7 PourInput \u5132\u5b58\u622a\u5716\u6a94\u6848\u52d5\u4f5c\u7684\u4f4d\u7f6e\u3002\u526a\u8cbc\u7c3f\u52d5\u4f5c\u4e0d\u53d7\u5f71\u97ff\u3002",
        ...
        "scroll.check_for_updates_desc": "\u6709\u65b0\u7248 PourInput \u53ef\u7528\u6642\u901a\u77e5\u3002\u4e0b\u8f09\u548c\u5b89\u88dd\u4ecd\u9700\u624b\u52d5\u5b8c\u6210\u3002",
        "scroll.update_idle": "PourInput \u53ef\u4ee5\u6aa2\u67e5\u65b0\u7248\u672c\u3002",
        "scroll.update_available": "PourInput %1 \u53ef\u7528\u3002",
        "scroll.update_checking": "\u6b63\u5728\u6aa2\u67e5\u66f4\u65b0...",
        "scroll.update_downloading": "\u6b63\u5728\u4e0b\u8f09\u66f4\u65b0...",
        "scroll.update_verifying": "\u6b63\u5728\u9a57\u8b49\u66f4\u65b0...",
        "scroll.update_ready": "PourInput \u9000\u51fa\u5f8c\u5373\u53ef\u5b89\u88dd\u3002",
        "scroll.update_installing": "\u6b63\u5728\u5b89\u88dd\u66f4\u65b0...",
        "scroll.update_installed": "\u66f4\u65b0\u5df2\u5b89\u88dd\u3002",
        "scroll.update_installed_version": "\u5df2\u66f4\u65b0\u5230 %1\u3002",
        "scroll.update_cancelled": "\u66f4\u65b0\u5df2\u53d6\u6d88\u3002",
        "scroll.update_manual": "\u6709\u65b0\u7248 PourInput \u53ef\u7528\u3002\u8acb\u5f9e\u767c\u5e03\u9801\u4e0b\u8f09\u4e26\u624b\u52d5\u5b89\u88dd\u3002",
        "scroll.update_manual_windows": "\u6709\u65b0\u7248 PourInput \u53ef\u7528\u3002\u8acb\u5f9e\u767c\u5e03\u9801\u4e0b\u8f09\u4e26\u5728 Windows \u4e0a\u624b\u52d5\u5b89\u88dd\u3002",
        "scroll.update_manual_macos": "\u6709\u65b0\u7248 PourInput \u53ef\u7528\u3002\u8acb\u5f9e\u767c\u5e03\u9801\u4e0b\u8f09\u4e26\u5728 macOS \u4e0a\u624b\u52d5\u5b89\u88dd\u3002",
        "scroll.update_manual_linux": "\u6709\u65b0\u7248 PourInput \u53ef\u7528\u3002\u8acb\u5f9e\u767c\u5e03\u9801\u4e0b\u8f09\u4e26\u5728 Linux \u4e0a\u624b\u52d5\u5b89\u88dd\u3002",
        "scroll.update_no_asset": "\u6b64\u96fb\u8166\u6c92\u6709\u53ef\u7528\u7684\u66f4\u65b0\u5957\u4ef6\u3002",
        "scroll.update_error": "\u7121\u6cd5\u6e96\u5099\u66f4\u65b0\u3002",
        "scroll.update_error_check_first": "\u8acb\u5148\u6aa2\u67e5\u66f4\u65b0\u3002",
        "scroll.update_error_network_error": "PourInput \u7121\u6cd5\u9023\u63a5\u66f4\u65b0\u670d\u52d9\u3002\u8acb\u7a0d\u5f8c\u91cd\u8a66\u3002",
        "scroll.update_error_metadata_missing": "\u66f4\u65b0\u8cc7\u8a0a\u5c1a\u672a\u6e96\u5099\u597d\u3002\u8acb\u958b\u555f\u767c\u5e03\u9801\u624b\u52d5\u5b89\u88dd\u3002",
        "scroll.update_error_metadata_invalid": "\u7121\u6cd5\u8b80\u53d6\u66f4\u65b0\u8cc7\u8a0a\u3002\u8acb\u958b\u555f\u767c\u5e03\u9801\u624b\u52d5\u5b89\u88dd\u3002",
        "scroll.update_error_permission_denied": "PourInput \u6c92\u6709\u6e96\u5099\u66f4\u65b0\u7684\u6b0a\u9650\u3002",
        "scroll.update_error_file_error": "PourInput \u7121\u6cd5\u5beb\u5165\u66f4\u65b0\u6a94\u6848\u3002",
        ...
        "scroll.update_error_older_build": "PourInput \u5df2\u62d2\u7d55\u8f03\u820a\u7684\u66f4\u65b0\u3002",
        ...
        "key_capture.error.unsupported_key": "\u8acb\u9078\u64c7\u5176\u4ed6\u6309\u9375\u3002%1 \u5728 PourInput \u4e2d\u7121\u6cd5\u4f7f\u7528\u3002",
        ...
        "tray.update_available": "PourInput {version} \u53ef\u7528\u3002\u8acb\u958b\u555f\u767c\u5e03\u9801\u9762\u624b\u52d5\u4e0b\u8f09\u3002",
        "tray.quit": "\u7d50\u675f PourInput",
        "tray.tray_message": "PourInput \u6b63\u5728\u7cfb\u7d71\u5217\u4e2d\u57f7\u884c\u3002\u9ede\u64ca\u5716\u793a\u958b\u555f\u8a2d\u5b9a\u3002",

        "accessibility.title": "\u9700\u8981\u8f14\u52a9\u4f7f\u7528\u6b0a\u9650",
        "accessibility.text": (
            "PourInput \u9700\u8981\u8f14\u52a9\u4f7f\u7528\u6b0a\u9650\u4ee5\u6514\u622a\u6ed1\u9f20\u6309\u9375\u4e8b\u4ef6\u3002\n\n"
            "macOS \u61c9\u5df2\u958b\u555f\u7cfb\u7d71\u8a2d\u5b9a\u63d0\u793a\u3002\n"
            "\u8acb\u6388\u4e88\u6b0a\u9650\uff0c\u7136\u5f8c\u91cd\u65b0\u555f\u52d5 PourInput\u3002"
        ),
        ...
        "about.title": "PourInput",
        "about.subtitle": "\u57f7\u884c\u6642\u3001\u767c\u884c\u8207\u5c08\u6848\u8cc7\u8a0a\u3002",
        "about.version": "\u7248\u672c\uff1a",
        "about.build_mode": "\u5efa\u7f6e\u6a21\u5f0f",
        "about.commit": "\u63d0\u4ea4",
        "about.maintainer": "\u7dad\u8b77\u8005\uff1a",
