...
_TRANSLATIONS = {
    "en": {
        "reading.space": "Space",
        "reading.tab": "Tab",
        "reading.escape": "Escape",
        "reading.title": "Reading",
        "reading.subtitle": "Read local TXT and EPUB files in a floating panel.",
        "reading.import": "Import TXT / EPUB",
        "reading.importing": "Importing…",
        "reading.enabled": "Reading Mode",
        "reading.auto_start": "Start / resume auto-scroll",
        "reading.auto_pause": "Pause auto-scroll",
        "reading.auto_speed": "Scroll speed",
        "reading.pixels_second": "px/s",
        "reading.auto_hint": "Text scrolls smoothly inside the panel. Hiding pauses scrolling; releasing resumes it. Scrolling stops at the end or when Reading Mode is turned off.",
        "reading.empty": "Import a book to begin.",
        "reading.no_document": "No document",
        "reading.previous": "Previous",
        "reading.next": "Next",
        "reading.mode": "Display mode",
        "reading.normal": "Normal",
        "reading.minimal": "Minimal",
        "reading.ghost": "Ghost",
        "reading.opacity": "Opacity",
        "reading.width": "Panel width",
        "reading.height": "Panel height",
        "reading.auto_height": "Default height",
        "reading.transparent": "Transparent background",
        "reading.font_size": "Font size",
        "reading.font_color": "Text color…",
        "reading.hex": "Text color hex value",
        "reading.style_hint": "Drag the small grip at the top right to move the panel in any mode. Transparent background leaves text visible. Drag the bottom-right corner to resize. Font size stays fixed; overflow continues on the next page.",
        "reading.hide": "Hold to hide",
        "reading.hide_choice": "Hide key or mouse button",
        "reading.hide_hint": "Hold the selected key or button to hide the panel; release to show it again. Reading stays on and the wheel still navigates. The selected mouse button only controls visibility while reading; keyboard keys retain their usual action.",
        "reading.wheel_hint": "Wheel up goes to the previous page; wheel down goes to the next. Pause briefly between gestures. Text in Minimal and Ghost modes lets clicks pass through.",
        "reading.unsupported": "Wheel interception is available on Windows.",
        "reading.move": "Move reading panel",
        "reading.resize": "Resize reading panel",
        "reading.panel_title": "PourInput Reading Panel",
        "reading.dialog_import": "Import reading file",
        "reading.file_filter": "Reading files (*.txt *.epub)",
        "reading.color_title": "Text color",
        "reading.error": "Unable to update reading settings. Please try again.",
        "reading.import_error": "Unable to import this file. Choose a readable TXT or EPUB file.",
        "reading.store_error": "Unable to load reading data. Existing files have been preserved.",
        "reading.none": "None",
        "reading.middle": "Middle button",
        "reading.back": "Back button",
        "reading.forward": "Forward button",
        "reading.left": "Left button",
        "reading.right": "Right button",
        # Navigation sidebar
        ...
        "mouse.device_fallback_name": "Mouse device",
        "mouse.generic_layout_note": "Generic Mouse Mode uses standard Windows mouse events and does not require a dedicated device overlay.",
        ...
        "about.build_mode.packaged": "Packaged app",
        "about.build_mode.source": "Source checkout",
        "about.commit": "Commit",
    ...
    "zh_CN": {
        "reading.space": "空格键",
        "reading.tab": "制表键（Tab）",
        "reading.escape": "退出键（Esc）",
        "reading.title": "阅读",
        "reading.subtitle": "导入本地 TXT 或 EPUB 文件，在浮窗中阅读。",
        "reading.import": "导入 TXT / EPUB",
        "reading.importing": "正在导入…",
        "reading.enabled": "阅读模式",
        "reading.auto_start": "开始／继续自动阅读",
        "reading.auto_pause": "暂停自动阅读",
        "reading.auto_speed": "滚动速度",
        "reading.pixels_second": "像素／秒",
        "reading.auto_hint": "文字在浮窗内连续滚动。按住隐藏键时暂停，松开后继续；读到末尾或关闭阅读模式时停止。",
        "reading.empty": "导入文件后，即可开始阅读。",
        "reading.no_document": "尚未导入文件",
        "reading.previous": "上一页",
        "reading.next": "下一页",
        "reading.mode": "显示模式",
        "reading.normal": "标准",
        "reading.minimal": "简洁",
        "reading.ghost": "隐约",
        "reading.opacity": "不透明度",
        "reading.width": "浮窗宽度",
        "reading.height": "浮窗高度",
        "reading.auto_height": "默认高度",
        "reading.transparent": "背景完全透明",
        "reading.font_size": "字号",
        "reading.font_color": "文字颜色…",
        "reading.hex": "文字颜色色值",
        "reading.style_hint": "直接拖动浮窗右上角的小拖动柄，即可在任何模式下移动。背景透明时仍显示文字；拖动右下角可调整大小，字号保持不变，放不下的文字会接到下一页。",
        "reading.hide": "按住隐藏",
        "reading.hide_choice": "隐藏快捷键或鼠标按钮",
        "reading.hide_hint": "按住所选按键或鼠标按钮可暂时隐藏浮窗，松开即恢复。阅读模式保持开启，滚轮仍可导航。所选鼠标按钮只控制隐藏；键盘按键仍保留原有功能。",
        "reading.wheel_hint": "滚轮向上切到上一页，向下切到下一页；两次操作之间请稍作停顿。简洁和隐约模式下，可直接点击浮窗后面的内容。",
        "reading.unsupported": "滚轮接管功能目前仅支持 Windows。",
        "reading.move": "移动阅读浮窗",
        "reading.resize": "调整阅读浮窗大小",
        "reading.panel_title": "PourInput 阅读浮窗",
        "reading.dialog_import": "导入阅读文件",
        "reading.file_filter": "阅读文件 (*.txt *.epub)",
        "reading.color_title": "文字颜色",
        "reading.error": "无法更新阅读设置，请重试。",
        "reading.import_error": "无法导入此文件，请选择可正常读取的 TXT 或 EPUB 文件。",
        "reading.store_error": "无法读取阅读记录，原有文件已保留。",
        "reading.none": "不设置",
        "reading.middle": "鼠标中键",
        "reading.back": "后退键",
        "reading.forward": "前进键",
        ...
        "mouse.device_fallback_name": "\u9f20\u6807\u8bbe\u5907",
        "mouse.generic_layout_note": "\u901a\u7528\u9f20\u6807\u6a21\u5f0f\u4f7f\u7528\u6807\u51c6 Windows \u9f20\u6807\u4e8b\u4ef6\uff0c\u65e0\u9700\u4e13\u7528\u8bbe\u5907\u8986\u76d6\u5c42\u3002",
        ...
        "about.build_mode.packaged": "\u5df2\u6253\u5305\u5e94\u7528",
        "about.build_mode.source": "\u6e90\u7801\u68c0\u51fa",
        "about.commit": "\u63d0\u4ea4",
    ...
    "zh_TW": {
        ...
        "mouse.device_fallback_name": "\u6ed1\u9f20\u88dd\u7f6e",
        "mouse.generic_layout_note": "\u901a\u7528\u6ed1\u9f20\u6a21\u5f0f\u4f7f\u7528\u6a19\u6e96 Windows \u6ed1\u9f20\u4e8b\u4ef6\uff0c\u7121\u9700\u5c08\u7528\u88dd\u7f6e\u8986\u84cb\u5c64\u3002",
        ...
        "about.build_mode.packaged": "\u5df2\u5c01\u88dd\u61c9\u7528\u7a0b\u5f0f",
        "about.build_mode.source": "\u539f\u59cb\u78bc\u6aa2\u51fa",
        "about.commit": "\u63d0\u4ea4",
