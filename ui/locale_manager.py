...
_TRANSLATIONS = {
    "en": {
        ...
        "reading.hide_hint": "Hold the selected key or button to hide the panel; release to show it again. Reading stays on and the wheel still navigates. The button keeps its usual action.",
    ...
    "zh_CN": {
        ...
        "reading.hide_hint": "按住所选按键或鼠标按钮可暂时隐藏浮窗，松开即恢复。阅读模式保持开启，滚轮仍可翻组；按钮原有功能也会保留。",
